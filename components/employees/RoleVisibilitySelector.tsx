...
export default function RoleVisibilitySelector({
  ...
  return (
    <div className="bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 rounded-2xl p-6 shadow-xl space-y-4 h-full">
      ...
      <p className="text-[11px] text-slate-500 dark:text-slate-400">
        Choose which roles can see this record. Select all roles to make it visible to everyone. Admins can always see every record.
      </p>
